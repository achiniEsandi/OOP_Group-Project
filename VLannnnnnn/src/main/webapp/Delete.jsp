        ...
        <div class="right-half">
            <form action="DeleteServlet" method="post">
				...
				<center><h1><u>Delete Payment Details</u></h1></center>
                    ...
                    <input type="text" id="name" name="cardholdername" required value="<%= cardholdername %>" readonly>
                ...
                <div class="column">
                    ...
                    <input type="text" id="cardnumber" name="cardnumber" required value="<%= cardnumber %>" readonly>
                    
                    <label for="expiredate">expire date</label>
                    <input type="text" id="expiredate" name="expiredate" required value="<%= expiredate %>" readonly>
                    
                    <label for="cvvcode">CVV code</label>
                    <input type="text" id="cvvcode" name="cvvcode" required value="<%= CVVcode %>" readonly>
               
                    <label for="amount">Payment Amount</label>
                    <input type="text" id="amount" name="amount" value="<%= Amount %>" readonly>
                </div>
                <div class="btncls">
                    <button type="submit" onclick="popup()">Confirm Delete</button>
                </div>
                
                <script>    
                        function popup()
                        {
                            alert("Payment details deleted sucessful ");
                        }   
                </script>
